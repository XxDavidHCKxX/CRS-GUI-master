namespace CRS.GameFiles
{
    ...
    {
        public Area_Effect_Objects(CSVRow row, DataTable dt) : base(row, dt)
        {
        ...
        public bool CapBuffTimeToAreaEffectTime
        {
            get; set;
        }
        ...
        public bool ProjectilesToCenter
        {
            get; set;
        }

        public string SpawnsAEO
        {
            get; set;
        }
    }
