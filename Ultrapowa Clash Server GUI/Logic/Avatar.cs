namespace CRS.Logic
{
    internal class Avatar
    {
        ...
        // {
        // if(data.GetDataType() == (int)Gamefile.Resources)
        // {
        // if(commodityType == 0)
        // {
        // int resourceCount = GetResourceCount((Resources)data);
        // int newResourceValue = Math.Max(resourceCount + count, 0);
        // if(count >= 1)
        // {
        // int resourceCap = GetResourceCap((Resources)data);
        ...
        // }
        // }
        // //SetResourceCount((Resources)data, newResourceValue);
        // }
        // }
        // }
        ...
        // public int GetResourceCap(Resources rd)
        // {
        ...
        // public int GetUnusedResourceCap(Resources rd)
        // {
        // int resourceCount = GetResourceCount((Resources)rd);
        // int resourceCap = GetResourceCap((Resources)rd);
        ...
        // public void SetResourceCap(Resources rd, int value)
        // {
        // int index = GetDataIndex(m_vResourceCaps, rd);
        // if(index == -1)
        // {
