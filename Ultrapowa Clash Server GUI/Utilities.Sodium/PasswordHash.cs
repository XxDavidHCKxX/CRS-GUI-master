using System;
using System.Text;
using CRS.Utilities.Sodium.Exceptions;
	...
	public class PasswordHash
	{
		...
		public static string ScryptHashString(string password, PasswordHash.Strength limit = PasswordHash.Strength.Interactive)
		{
			...
			case PasswordHash.Strength.Interactive:
				...
				memLimit = 16777216;
				break;
#pragma warning disable CS0618 // 'PasswordHash.Strength.Moderate' está obsoleto: 'Use Strength.Medium instead.'
			case PasswordHash.Strength.Moderate:
#pragma warning restore CS0618 // 'PasswordHash.Strength.Moderate' está obsoleto: 'Use Strength.Medium instead.'
				opsLimit = 8388608L;
				memLimit = 100000000;
				break;
