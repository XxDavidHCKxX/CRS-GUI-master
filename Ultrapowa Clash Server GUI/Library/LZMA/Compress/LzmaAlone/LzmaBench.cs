// LzmaBench.cs
namespace CRS.Library.LZMA.Compress.LzmaAlone
{
    #region Usings
    ...
    using CRS.Library.LZMA.Common;
    using CRS.Library.LZMA.Compress.LZMA;
    ...
    internal abstract class LzmaBench
    {
        ...
        static public int LzmaBenchmark(int numIterations, uint dictionarySize)
        {
            ...
            Console.Write("     ");
            PrintResults(dictionarySize, totalDecodeTime, kBufferSize * (UInt64)numIterations, true, totalCompressedSize);
        ...
        private static ulong GetCompressRating(uint dictionarySize, ulong elapsedTime, ulong size)
        {
            ...
            ulong numCommands = (UInt64)size * numCommandsForOne;
