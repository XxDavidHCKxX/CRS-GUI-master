// LzInWindow.cs
namespace CRS.Library.LZMA.Compress.LZ
{
    #region Usings
    ...
    public class InWindow
    {
        ...
        {
            uint offset = (UInt32)this._bufferOffset + this._pos - this._keepSizeBefore;
            ...
            uint numBytes = (UInt32)this._bufferOffset + this._streamPos - offset;
